    ...
    <div className='boxes'>
        <div className="box active">
          ...
          <div className='section-2'>
            <p className='bold'>Arcade</p>
          <p className='light'>$90/yr</p>
          <small>2 months free</small>
          </div>
        </div>
        <div className="box box-2" onClick={handleClickTwo}>
          <div className='section-1'>
          ...
          <p className='light'>$120/yr</p>
          <small>2 months free</small>
          </div>
        </div>
        <div className="box box-3" onClick={handleClickThree}>
          <div className='section-1'>
